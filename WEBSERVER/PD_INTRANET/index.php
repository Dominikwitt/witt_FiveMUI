                        ...
                        <div class="col-md-12">
                            <div class="navbar-collapse collapse ">
                                <ul id="menu-top" class="nav navbar-nav navbar-right">
                                    <li>
                                        <a href="index.php" class="menu-top-active"> Start Seite</a>
                                    </li>
                                    <li>
                                        <a href="add_criminal.php">Akte Anlegen</a>
                                    </li>
									<li>
            ...
            <div class="content-wrapper">
                <div class="container">
                    <div class="row pad-botm">
                        <div class="col-md-12">
                            <h4 class="header-line">LAPD Intranet</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            <thead>
                                                <tr>													
                                                    <th>Akten ID</th>
                                                    <th>Vor und Zu Name</th>
                                                    <th>Telefonnummer</th>
                                                    <th>Mitarbeiter Dienstnummer</th>
                                                    <th>Straftat</th>
                                                    <th>Ergebnis</th>
                                                    <th>
                                                    Entfernen
